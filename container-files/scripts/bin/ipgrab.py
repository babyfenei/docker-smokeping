...
def infoInit():
    ...
    province_info["guangdong"] = {"name" : "广东" , "abbr" : "guangdong" , "url" : "http://ip.yqie.com/cn/guangdong/"}
...
def syncToSmokingFile(province_info):
    ...
    data['cmcc'] = "+ CMCC \n" \
                   "menu = 移动 \n" \
                   "title = 移动 \n" \
                   "host = /IDC/CMCC/beijing   /IDC/CMCC/tianjin   /IDC/CMCC/hebei   /IDC/CMCC/neimenggu   /IDC/CMCC/liaoning   /IDC/CMCC/heilongjiang   /IDC/CMCC/jilin   /IDC/CMCC/shandong   /IDC/CMCC/shanxi   /IDC/CMCC/shanghai   /IDC/CMCC/zhejiang   /IDC/CMCC/jiangsu   /IDC/CMCC/anhui   /IDC/CMCC/jiangxi   /IDC/CMCC/fujian   /IDC/CMCC/henan   /IDC/CMCC/hubei   /IDC/CMCC/hunan   /IDC/CMCC/guangdong   /IDC/CMCC/guangxi   /IDC/CMCC/hainan   /IDC/CMCC/sichuan   /IDC/CMCC/chongqing   /IDC/CMCC/guizhou   /IDC/CMCC/yunnan   /IDC/CMCC/xizang   /IDC/CMCC/shaanxi   /IDC/CMCC/ningxia   /IDC/CMCC/gansu   /IDC/CMCC/qinghai   /IDC/CMCC/xinjiang  \n" \
                   "\n"
    data['unicom'] = "+ UNICOM \n" \
                   "menu = 联通 \n" \
                   "title = 联通 \n" \
                   "host = /IDC/UNICOM/beijing   /IDC/UNICOM/tianjin   /IDC/UNICOM/hebei   /IDC/UNICOM/neimenggu   /IDC/UNICOM/liaoning   /IDC/UNICOM/heilongjiang   /IDC/UNICOM/jilin   /IDC/UNICOM/shandong   /IDC/UNICOM/shanxi   /IDC/UNICOM/shanghai   /IDC/UNICOM/zhejiang   /IDC/UNICOM/jiangsu   /IDC/UNICOM/anhui   /IDC/UNICOM/jiangxi   /IDC/UNICOM/fujian   /IDC/UNICOM/henan   /IDC/UNICOM/hubei   /IDC/UNICOM/hunan   /IDC/UNICOM/guangdong   /IDC/UNICOM/guangxi   /IDC/UNICOM/hainan   /IDC/UNICOM/sichuan   /IDC/UNICOM/chongqing   /IDC/UNICOM/guizhou   /IDC/UNICOM/yunnan   /IDC/UNICOM/xizang   /IDC/UNICOM/shaanxi   /IDC/UNICOM/ningxia   /IDC/UNICOM/gansu   /IDC/UNICOM/qinghai   /IDC/UNICOM/xinjiang  \n" \
                   "\n"
    data['telcom'] = "+ TELCOM \n" \
                   "menu = 电信 \n" \
                   "title = 电信 \n" \
                   "host = /IDC/TELCOM/beijing   /IDC/TELCOM/tianjin   /IDC/TELCOM/hebei   /IDC/TELCOM/neimenggu   /IDC/TELCOM/liaoning   /IDC/TELCOM/heilongjiang   /IDC/TELCOM/jilin   /IDC/TELCOM/shandong   /IDC/TELCOM/shanxi   /IDC/TELCOM/shanghai   /IDC/TELCOM/zhejiang   /IDC/TELCOM/jiangsu   /IDC/TELCOM/anhui   /IDC/TELCOM/jiangxi   /IDC/TELCOM/fujian   /IDC/TELCOM/henan   /IDC/TELCOM/hubei   /IDC/TELCOM/hunan   /IDC/TELCOM/guangdong   /IDC/TELCOM/guangxi   /IDC/TELCOM/hainan   /IDC/TELCOM/sichuan   /IDC/TELCOM/chongqing   /IDC/TELCOM/guizhou   /IDC/TELCOM/yunnan   /IDC/TELCOM/xizang   /IDC/TELCOM/shaanxi   /IDC/TELCOM/ningxia   /IDC/TELCOM/gansu   /IDC/TELCOM/qinghai   /IDC/TELCOM/xinjiang  \n" \
                   "\n"

 
    for province in province_info:
        if province_info[province].get('cmcc'):
            print(province_info[province].get('abbr'))
            record = "++ " + province_info[province].get('abbr') + "\n" \
                     "menu = " + province_info[province].get('name') + "\n" \
                     "title = " + province_info[province].get('name') + "-" + province_info[province].get('cmcc') + "\n" \
        ...
        if province_info[province].get('unicom'):
            record = "++ " + province_info[province].get('abbr') + "\n" \
                     "menu = " + province_info[province].get('name') + "\n" \
                     "title = " + province_info[province].get('name') + "-" + province_info[province].get('unicom') + "\n" \
        ...
        if province_info[province].get('telcom'):
            record = "++ " + province_info[province].get('abbr') + "\n" \
                     "menu = " + province_info[province].get('name') + "\n" \
                     "title = " + province_info[province].get('name') + "-" + province_info[province].get('telcom') + "\n" \
                     "host = " + province_info[province].get('telcom') + "\n" \
                     "\n"
            data['telcom'] += record
 
    for isp in data:
        with open("/smokeping/etc/location/"+isp , "w") as f:
...
if __name__ == '__main__':
    ...
    print(getDate() , 'end...')
    os.system('/smokeping/bin/smokeping -reload')
